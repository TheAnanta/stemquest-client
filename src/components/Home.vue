    ...
    <div className="flex flex-col absolute h-screen items-start justify-center lg:px-32 px-8 py-16">
      <div className="flex items-center justify-between grow">
        <div className="sm:w-5/12">
          <h2 id="bold" className="text-4xl py-1 text-[#1E5B85]">Lorem ipsum dolor sit amet,<br />consectetur adipiscing
            elit. </h2>
      ...
      <div
        ...
        <button className="bg-[#78a3f3e7] hover:bg-[#78a3f3] text-white px-2 py-1 mx-2 rounded-md z-20 duration-200">as
          student</button>
